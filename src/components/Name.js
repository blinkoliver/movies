...
class Name extends React.Component{
    ...
    fetchPeopleInfo(){
        fetch(`https://api.themoviedb.org/3/person/${this.props.match.params.id}?api_key=6ed6e56030be8bc7d1821d5b302e302e&language=en-US`)
    ...
    fetchMovieInfo(){
        fetch(`https://api.themoviedb.org/3/person/${this.props.match.params.id}/movie_credits?api_key=6ed6e56030be8bc7d1821d5b302e302e&language=en-US`)
            .then(information=>information.json())
            .then(post=>{
