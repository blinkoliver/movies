...
import {
  ...
  setTrailers,
  setRecommendations
} from "../actions/informationAboutFilm";
...
class InformationPage extends React.Component {
  ...
  render() {
    ...
    if (this.props.informationAboutFilmLoading)
      return (
        <div className={"Container"}>
            ...
            <div className={"TitleBar"}>
              ...
              <div className={"Subtext"}>
                <div>
                  {moment
                    .duration(
                      this.props.informationAboutFilm.runtime,
                      "minutes"
                    )
                    .format("h:mm")
                    .replace(":", "h ") + "min"}
                ...
                <div>
                  {genres.map((el, index) => {
                    const name =
                      index ===
                      this.props.informationAboutFilm.genres.length - 1
                        ? el.name
                        : `${el.name}, `;
                    return (
          ...
          <div className={"Overview"}>
            ...
            <div className={"CastCrew"}>
              ...
              {this.props.castAndCrew.cast.length !== 0 && (
                <div>
                  <b>Stars: </b>
          ...
          {this.props.recommendations.results.length !== 0 && (
            <div className={"KnownFor"} style={{ marginLeft: "60px" }}>
              <h3>
                <b>Recommendations</b>
              </h3>
              <div className={"KnownForItems"}>
                {this.props.recommendations.results
                  .slice(0, 4)
                  .map((result) => (
                    <div key={result.id}>
                      <Link
...
const mapStateToProps = (props) => ({
  informationAboutFilm: props.informationAboutFilm.informationAboutFilm,
  trailers: props.informationAboutFilm.trailers,
  castAndCrew: props.informationAboutFilm.castAndCrew,
  recommendations: props.informationAboutFilm.recommendations,
  informationAboutFilmLoading:
    props.informationAboutFilm.informationAboutFilmLoading
});

const mapDispatchToProps = (dispatch) => ({
  setInformationAboutFilm: (informationAboutFilm) =>
    dispatch(setInformationAboutFilm(informationAboutFilm)),
  setTrailers: (trailers) => dispatch(setTrailers(trailers)),
  setCastAndCrew: (castAndCrew) => dispatch(setCastAndCrew(castAndCrew)),
